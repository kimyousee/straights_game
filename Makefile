...
OBJECTS = main.o DeckGUI.o DialogBox.o StartGameDialogBox.o View.o Card.o Command.o Controller.o Deck.o Model.o Player.o HumanPlayer.o ComputerPlayer.o Table.o Observer.o Subject.o 
